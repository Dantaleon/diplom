...
public class Controller extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		NextPage nextPage = new NextPage(CommandEnumGuest.CHome.getView(), NextPage.REDIRECT_TYPE_REDIRECT);
	...
	private void dispatch(HttpServletRequest request, HttpServletResponse response, NextPage nextPage)
			throws ServletException, IOException {
		if (nextPage.getRedirectType().equals(NextPage.REDIRECT_TYPE_FORWARD)) {
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher(nextPage.getPage());
